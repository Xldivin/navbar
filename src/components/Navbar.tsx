...
const Navbar = (props: ITexts & { versions1: string[] } & { versions2: string[] } & {versions3: string[];} & { links: string[] } & { resources: string[] }) => {
  const {
    text1,
    text2,
    text3,
  ...
  return (
    ...
    >
      ...
      {mobileMenu && (
        ...
        //   />
        // </div>
        <NavbarPhone text1={text1} text2={text2} text3={text3} text4={text4} versions1={versions1} versions2={versions2} versions3={versions3} links={links} resources={resources} />
      )}
    </nav>
  );
};
